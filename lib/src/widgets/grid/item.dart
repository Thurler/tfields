...
import 'package:tfields/src/widgets/grid/size.dart';
...
class TGridItem {
  ...
  TGridItem({
    ...
    _NullSizeMap nullableSizes = <TGridBreakpoint, TGridSize?>{
      ...
      TGridBreakpoint.fhd: fhd ?? xxxl ?? xxl ?? xl ?? lg ?? md ?? sm ?? xs,
      TGridBreakpoint.qhd:
          qhd ?? fhd ?? xxxl ?? xxl ?? xl ?? lg ?? md ?? sm ?? xs,
      TGridBreakpoint.uhd:
          uhd ?? qhd ?? fhd ?? xxxl ?? xxl ?? xl ?? lg ?? md ?? sm ?? xs,
    };
